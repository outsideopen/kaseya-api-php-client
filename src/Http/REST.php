...
class REST
{
	public static function execute(ClientInterface $client, RequestInterface $request, $expectedClass = null)
	{
		try {
	...
	public static function decodeHttpResponse(
		...
		if (intVal($code) >= 400) {
			...
			throw new \RuntimeException(self::getResponseErrors($body), $code);
		}
