	...
	implements \ArrayAccess
{
	 ...
	 */
	const NULL_VALUE = "{}kapi-php-null";
	protected $internal_kapi_mappings = array();
	...
	public function __construct()
	{
		if (func_num_args() == 1 && is_array(func_get_arg(0))) {
			...
			$this->mapTypes(isset($array['Result']) ? $array["Result"] : $array);
		}
		$this->kapiInit();
	}
	...
	{
		if (isset($this->internal_kapi_mappings, $this->internal_kapi_mappings[$key])) {
			$key = $this->internal_kapi_mappings[$key];
		}
	 ...
	 *
	 * @throws \RuntimeException Thrown if $obj isn't an array.
